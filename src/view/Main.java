...
//		Pessoa medico0 = new Medico("M�dico 0", ((DateFormat) "12/05/1976"), 1234567890, "medico0", "senha0", 654321);
...
//			System.out.println("A pessoa " + e.getNome() + " com o CPF " + e.getCPF() + " já está cadastrada.");
//		} 
//		
//		try {
...
//		} catch (ExceptionAtendimentoCadastrado e1) {
//			e1.printStackTrace();
//		}
//		
...
//		} catch (ExceptionAtendimentoNaoEncontrado | ExceptionAtendimentoCadastrado e1) {
//			e1.printStackTrace();
//		}
...
//		} catch (ExceptionPessoaNaoEncontrada | ExceptionAtendimentoNaoEncontrado e) {
//			e.printStackTrace();
//		}
//		
//		try {
...
//		} catch (ExceptionAtendimentoNaoEncontrado e) {
//			e.printStackTrace();
//		}
//		
